<%-- 
    Document   : outgoingSocity
    Created on : Apr 1, 2021, 11:48:02 AM
    Author     : paurash
--%>
...
<html>
    ...
    <body style="background-color:lightskyblue">
        <div class="d1">
            <form action="outgoigSocityRegister" method="post">
            <h1 style="color: red">Outgonig Socity</h1>
            <hr style="color:black">
            <table width="80%" style="margin: auto">
                <tr><td>SOCITY ID</td><td><input type="text" name="outgoingid"></td></tr>
