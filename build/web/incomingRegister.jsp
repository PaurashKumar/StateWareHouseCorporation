<%-- 
    Document   : incomingRegister
    Created on : Mar 31, 2021, 12:05:49 PM
    Author     : paurash
--%>
...
<html>
    <head>
        ...
        <title>INCOMING LONG ROUT</title>
        <style>
        .d1{
    ...
    <body style="background-color:lightskyblue">
        <div class="d1">
            ...
            <h1 style="color: red">Incoming Long Rout</h1>
            ...
            <input type="submit" value="SEARCH" style="color:red; width:80%;background-color:lightskyblue;height:20% ">
            <br><br>
