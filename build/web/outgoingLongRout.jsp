<%-- 
    Document   : outgoingLongRout
    Created on : Apr 1, 2021, 11:38:44 AM
    Author     : paurash
--%>
...
<html>
    <head>
        ...
        <title>OUTGOING LONG ROUT</title>
     <style>
        .d1{
    ...
    <body style="background-color:lightskyblue">
        <div class="d1">
            <form action="outgoingLRregister" method="post">
            <h1 style="color: red">Outgonig Long Rout</h1>
            <hr style="color:black">
            <table width="80%" style="margin: auto">
                <tr><td>OUTGOING ID</td><td><input type="text" name="outgoingid"></td></tr>
                <tr><td>SW ID</td><td><input type="text" name="swid"></td></tr>
